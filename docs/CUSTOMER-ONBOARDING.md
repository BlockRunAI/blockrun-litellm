...
All image models return HTTPS proxy URLs. The BlockRun server handles any provider-level differences (e.g. base64 payloads from Google Imagen) before responding.
